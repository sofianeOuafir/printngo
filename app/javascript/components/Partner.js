...
const Partner = ({
  ...
  return (
    <div
      ...
      } pointer mb2 flex justify-content--between p2 border border-color--grey flex align-items--center`}
    >
      <div className="h5 col-8">
        <div className="flex flex-direction--column mr2">
          <span className="h4">{partner.name}</span>
          <span className="pt1">{partner.address} {partner.city} {partner.postcode}</span>
