  ...
  render() {
    ...
    return (
      <div>
        <a id='how-it-works'></a>
        <div
          className={`bg-orange fullscreen border--bottom border-color--white justify-content--center text-white flex align-items--center`}
        >
          <div className="content-container">
            <h1 className="m0 h2 favourite-font-weight mb3 center">
              How It Works?
            </h1>
            <div className="flex justify-content--around">
              {steps.map((step, index) => (
                <div
                  key={index}
                  className="flex col-3 center align-items--center flex-direction--column px1"
                >
