...
class HomePage extends React.Component {
  render () {
    const sections = [{
      ...
      description: "How? Our pick up locations are your favourite convenient stores, pharmacies and any kind of shops that has a printing machine.",
      ...
      description: "We suppress the need of both commuting and accessing a computer.", 
