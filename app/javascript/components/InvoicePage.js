          ...
          <Document>
            <Page style={styles.page} size="A4">
              <View
                style={
                  (styles.table,
                  { borderBottom: "1 black solid", paddingBottom: 10 })
                }
              >
                <View style={[styles.row, styles.rowWithoutBorder]}>
                  ...
                  <Text
                    style={[
                      ...
                      { textAlign: "left", fontSize: 20, paddingLeft: 10 }
                    ]}
                  >
                    Print N' Go
                  </Text>
              ...
              <View
                style={(styles.table, { paddingBottom: 10, marginBottom: 10 })}
              >
                <View
                  style={[
                    styles.row,
              ...
              <View style={styles.table}>
                ...
                <View
                  style={[
                    styles.row,
                    { marginTop: 5, border: "0 black solid" }
                  ]}
                >
